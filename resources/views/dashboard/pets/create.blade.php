...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl p-8 border-2 border-[#E5F0ED] shadow-lg">
        <div class="mb-8">
            ...
            <p class="text-[#5A7A76]">Lengkapi data hewan peliharaan Anda</p>
        </div>
                ...
                <div class="relative">
                    ...
                    >
                        <div id="photo-preview" class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="mb-2 text-sm text-[#5A7A76]"><span class="font-semibold">Klik untuk upload</span> atau drag & drop</p>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm text-[#2E7D32]">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            <li>Foto hewan <strong>wajib diupload</strong> untuk keperluan identifikasi</li>
                            <li>Pastikan foto jelas dan menampilkan wajah hewan</li>
                            <li>Semua data dapat diubah nanti jika diperlukan</li>
                        </ul>
                    </div>
                </div>
            </div>
